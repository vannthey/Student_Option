...
public class Adapter_Freshman_S2_Score extends RecyclerView.Adapter<Adapter_Freshman_S2_Score.ViewHolder> {
    private final List<String> Subject_S2, Rank_S2, Grade_S2, Total_S2;

    public Adapter_Freshman_S2_Score(List<String> subject_S2, List<String> rank_S2, List<String> grade_S2, List<String> total_S2) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        private final TextView txtSubject, txtRank, txtGrade, txtTotal;
